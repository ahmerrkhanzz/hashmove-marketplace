  ...
  getDropDown() {
    ...
    jQuery(document).ready(function ($) {
      ...
      function toggleNav() {
        ...
        if($('.cd-dropdown-trigger')[0].children[0].classList.contains('fa-angle-down')){
          $('.cd-dropdown-trigger')[0].children[0].classList.remove('fa-angle-down')
          $('.cd-dropdown-trigger')[0].children[0].classList.add('fa-times')
        }
        // debugger;
        if (!navIsVisible) {
          if($('.cd-dropdown-trigger')[0].children[0].classList.contains('fa-times')){
            $('.cd-dropdown-trigger')[0].children[0].classList.remove('fa-times')
            $('.cd-dropdown-trigger')[0].children[0].classList.add('fa-angle-down')
          }
