...
export type ForwardAction = ForwarderActions.AllForwarder
...
//Reducer function
export function fclForwarderReducer(state: FclForwarderState = initialState, action: any) {

  switch (action.type) {
    case ForwarderActions.FETCHING_FCL_FORWARDER_DATA: return newState(state, {
      loading: true,
      loaded: false,
      data: null,
      hassError: null,
    ...
    case ForwarderActions.FETCHING_FCL_FORWARDER_DATA_SUCCESS:
    ...
    case ForwarderActions.FETCHING_FCL_FORWARDER_DATA_FAIL: return newState(state, {
      loading: false,
      loaded: true,
      data: null,
      hassError: true,
    ...
    case ForwarderActions.UPDATE_FCL_FORWARDER_SEARCH_RESULT:
    ...
    case ForwarderActions.UPDATE_FCL_FORWARDER_VIEW_SEARCH_RESULT:
    ...
    case ForwarderActions.UPDATE_FCL_FORWARDER_MAIN_SEARCH_RESULT:
      return newState(state, {
        loading: false,
        loaded: true,
        data: {
...
export const getFclInitalForwarderState = () => initialState
